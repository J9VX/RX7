...
from Opus import app  # Replace with your actual Client instance
...
async def recheck_callback(client: Client, callback_query: CallbackQuery):
    ...
    if not blocked:
        ...
        await client.send_message(
            chat_id=user.id,
            text="✅ ʏᴏᴜ ʜᴀᴠᴇ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴊᴏɪɴᴇᴅ ʙᴏᴛʜ! ʏᴏᴜ ᴄᴀɴ ɴᴏᴡ ᴜꜱᴇ ᴛʜᴇ ʙᴏᴛ."
        )
